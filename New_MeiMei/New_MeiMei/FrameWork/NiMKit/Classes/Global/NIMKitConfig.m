...
- (void)applyDefaultTextSettings
{
    ...
    _textSetting.textColor = [UIColor colorWithRed:51/255.0 green:51/255.0 blue:51/255.0 alpha:1];
...
- (void)applyDefaultAudioSettings
{
    ...
    _audioSetting.textColor = [UIColor colorWithRed:51/255.0 green:51/255.0 blue:51/255.0 alpha:1];
...
- (void)applyDefaultVideoSettings
{
    ...
    _videoSetting.textColor = [UIColor colorWithRed:51/255.0 green:51/255.0 blue:51/255.0 alpha:1];
