...
- (void)setRecording:(BOOL)recording
{
    if(recording)
    {
        ...
        center.y -= 150;
        self.audioRecordIndicator.center = center;
...
- (void)didPressSend:(id)sender{
    ...
    if ( [self.toolBar.contentText length] == 0 || [[self.toolBar.contentText stringByTrimmingCharactersInSet:NSCharacterSet.whitespaceCharacterSet] length] == 0) {
