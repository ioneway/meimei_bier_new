...
- (void)adjustInputView
{
    ...
    CGFloat height = 0;
    if (_inputViewHeight > 300){
         height = [UIScreen mainScreen].bounds.size.height == 812 || [UIScreen mainScreen].bounds.size.height == 896 ? 34 : 0;
        height += 53;
    }
    self.inputView.nim_bottom = superView.nim_height - safeAreaInsets.bottom  + height;
}
